    ...
    <main>
      <div className="chapterBox">
        <div className="textBox">
          <h2>Our Shelter</h2>
          <p>
            Welcome to our animal shelter. We're a dedicated team of animal
            lovers who work hard to provide a safe and comfortable home for all
            the animals in our care. Whether you're looking to adopt a new furry
            friend or simply want to support our cause, we're here to help. From
            dogs and cats to rabbits and birds, we have a wide variety of
            lovable creatures just waiting to find their forever homes. Each
            animal comes with a detailed profile, so you can learn more about
            their personality, likes, and dislikes before making your decision.
          </p>
        </div>
      ...
      <div className="chapterBox">
        ...
        <div className="textBox yellowBG">
          ...
          <p>
            ...
            <Link to="animals">Check out our animals</Link> and find your new
            best friend!
          </p>
        </div>
      </div>
